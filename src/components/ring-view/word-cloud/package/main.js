...
export class Js2WordCloud {
    ...
    setOption(option) {
        ...
        if (this._option && /\.(jpg|png)$/.test(this._option.imageShape)) {
            this._wordcloud2=_imageShape.call(this, this._option)
        } else if (this._option.shape === 'circle') {
            _circle.call(this, this._option)
        } else {
           this._wordcloud2=_renderShape.call(this, this._option)
        }
        //
        return word2
...
async function _imageShape(option) {
    var wordcloud2
    ...
    img.onerror = function(){
        this._wordcloud2=_renderShape.call(this, option);
    };
